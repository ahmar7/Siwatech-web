      ...
      <aside className="sidebar-main is--left is--inactive" style={{}}>
        ...
        <div className="sidebar--usps">
          ...
          <ul>
            <li>
              <font style={{ verticalAlign: "inherit" }}>
                <font style={{ verticalAlign: "inherit" }}>Telefon: +49 XXX XXXXXX</font>
              </font>
            </li>
            <li>
              <font style={{ verticalAlign: "inherit" }}>
                <font style={{ verticalAlign: "inherit" }}>Fax: +49 XXX XXXXXX</font>
              </font>
            </li>
            <li>
              <font style={{ verticalAlign: "inherit" }}>
            ...
            <p>
              <font style={{ verticalAlign: "inherit" }}>
                <font style={{ verticalAlign: "inherit" }}>
                  ...
                  Sie erreichen unser engagiertes Kundenservice-Team unter der Telefonnummer +49 XXX XXXXXX. Unsere Sprechzeiten sind von Montag bis Freitag von 09:00 bis 18:00 Uhr.
                  ...
                  Gerne können Sie uns auch schriftlich kontaktieren. Unsere Adresse lautet: XXXXX.
