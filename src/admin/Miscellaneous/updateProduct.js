...
import {
  addMiscProsuctApi,
  getSingleLandProductApi,
  getSingleMiscProductApi,
  isLoginApi,
  updateHeaderApi,
  updateLandProductApi,
  updateMiscProductApi,
} from "../../Api/Services";
...
const UpdateMiscProduct = () => {
  ...
  const getProductDeails = async () => {
    try {
      ...
      setisLogo(updateHeader.product.image.url);
...
export default UpdateMiscProduct;
