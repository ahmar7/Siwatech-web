...
const MiscBannerUpdate = () => {
  ...
  const updateBanners = async () => {
    try {
      ...
      const updateHeader = await addMiscBannerApi(formData);
  ...
  const getBanner = async () => {
    try {
      const getSlider = await getMiscBannerApi();
...
export default MiscBannerUpdate;
