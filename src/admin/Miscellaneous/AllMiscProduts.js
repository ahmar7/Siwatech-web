...
const AllMiscProducts = () => {
  ...
  const getAllProducts = async () => {
    try {
      const updateHeader = await getMiscProductApi();
  ...
  const deleteProducts = async (item) => {
    ...
    try {
      const updateHeader = await deleteMiscProductApi(item._id);
      console.log("updateHeader: ", updateHeader);
...
export default AllMiscProducts;
